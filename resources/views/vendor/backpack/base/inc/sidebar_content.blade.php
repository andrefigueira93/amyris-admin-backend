...
<li class='nav-item'><b> Business</b></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('client') }}'><i class='nav-icon la la-user-circle'></i> Clients</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('newsletter') }}'><i class='nav-icon la la-envelope'></i> Newsletters</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('project') }}'><i class='nav-icon la la-coins'></i> Projects</a></li>

<li class='nav-item'><b> Project Related</b></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('bundle') }}'><i class='nav-icon la la-file-archive'></i> Bundles</a></li>
...
<li class='nav-item'><b> Administration</b></li>
