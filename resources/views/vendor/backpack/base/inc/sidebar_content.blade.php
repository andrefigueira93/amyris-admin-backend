...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('landing-page') }}'><i class='nav-icon la la-question'></i> Landing pages</a></li>
...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('bundle') }}'><i class='nav-icon la la-question'></i> Bundles</a></li>
